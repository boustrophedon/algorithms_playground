...
def check_maps_equal(items: Iterable[Tuple[Hashable, Any]], test_map: MutableMapping) -> Tuple[bool, str]:
    expected = dict()
    ...
    for k,v in expected.items():
        ...
        if test_map[k] != v:
            return (False, "Key {} does not have the correct value {} in test map".format(k, v))
